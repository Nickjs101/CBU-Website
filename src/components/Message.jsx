      ...
      <div className="bg-white max-w-[1200px] h-auto md:h-[90vh] mx-auto shadow-xl flex flex-col md:flex-row ">
        <div className=" py-8 p-0 md:w-2/3 flex flex-col justify-center items-center md:items-start">
            ...
            <div className="text-center md:text-left px-4 md:px-24 my-8 md:mb-8 lg:mb-20">
                <p className="text-xl md:text-3xl text-gray-600 font-serif">
                    {message}
                </p>
            </div>
            <div className='px-8 md:px-24 text-center md:text-left '>
                <p className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 md:mb-4">{name}</p>
